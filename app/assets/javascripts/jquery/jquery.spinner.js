...
$.widget('ui.spinner', {
	...
	_createButtons: function(input) {
		...
		var self = this,
			...
			btnContainer = self.btnContainer = $(
				'<div class="ui-spinner-buttons">' + 
					'<div class="btn ui-spinner-up ui-spinner-button ui-state-default ui-corner-tr" style="padding:0px;">' +
						'<span class="ui-icon '+options.upIconClass+'">&nbsp;</span>' +
					'</div>' + 
					'<div class="btn ui-spinner-down ui-spinner-button ui-state-default ui-corner-br" style="padding:0px;">' +
						'<span class="ui-icon '+options.downIconClass+'">&nbsp;</span>' +
					'</div>' + 
				'</div>'),
		...
		// Calculate and Initiate Bootstrap Compatibilities - Change by Kevin Chiu
		input.css({ 
		...
		upButtonYDifference = input.offset().top - buttons.eq(0).offset().top;
		downButtonYDifference = (buttons.eq(0).offset().top + buttons.eq(0).height()) - buttons.eq(1).offset().top;

		buttons.eq(0).css({
			"width": 15,
			"margin-top": upButtonYDifference,
		...
		buttons.eq(1).css({
			"width": 15,
			"height": buttons.eq(1).height(),
			"margin-top": downButtonYDifference, 
			"border-bottom-left-radius": 0,
			"border-top-left-radius": 0,
			"border-top-right-radius": 0,
